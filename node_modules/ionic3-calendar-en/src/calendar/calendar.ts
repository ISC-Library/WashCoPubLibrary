        ...
        <ion-row class="calendar-row" *ngFor="let week of weekArray;let i = index">
            ...
            *ngFor="let day of week;let j = index"
            [ngClass]="[day.isThisMonth?'this-month':'not-this-month',day.isToday?'today':'',day.isSelect?'select':'']">
                {{day.date}}
                <span class="sportingBlip" *ngIf="day.isSporting"></span>
                <span class="communityBlip" *ngIf="day.isCommunity"></span>
                <span class="businessBlip" *ngIf="day.isBusiness"></span>
                <span class="artBlip" *ngIf="day.isArt"></span>
            </ion-col>
        </ion-row>
    ...
    createMonth(year: number, month: number) {
            ...
            for (let i = 0; i < firstDay; i++) {
                if (month === 0) {
                    this.dateArray.push({
                        ...
                        isSporting: (this.isSporting(year, 11, lastMonthStart+i)) ? true : false,
                        isCommunity: false,
                        isBusiness: false,
                        isArt: false,
                    })
                    ...
                    this.dateArray.push({
                        ...
                        isSporting: (this.isSporting(year, month-1, lastMonthStart+i)) ? true : false,
                        isCommunity: false,
                        isBusiness: false,
                        isArt: false,
                    })
        ...
        for (let i = 0; i < monthDays; i++) {
            this.dateArray.push({
                ...
                isSporting: (this.isSporting(year, month, i+1)) ? true : false,
                isCommunity: false,
                isBusiness: false,
                isArt: false,
            })
            ...
            for (let i = 0; i < nextMonthAdd; i++) {
                if (month === 11) {
                    this.dateArray.push({
                        ...
                        isSporting: (this.isSporting(year, 0, i+1)) ? true : false,
                        isCommunity: false,
                        isBusiness: false,
                        isArt: false,
                    })
                    ...
                    this.dateArray.push({
                        ...
                        isSporting: (this.isSporting(year, month+1, i+1)) ? true : false,
                        isCommunity: false,
                        isBusiness: false,
                        isArt: false,
                    })
