        ...
        for (; i < len; i++) {
            if (this.events[i].year == year && this.events[i].month == month && this.events[i].date == date) {
                ...
                if (this.events[i].category =="sporting") {
                    ...
                    if (counter > 1) { 
                        //IF there are in fact multiple events, just stop execution of the function and return "multiple"
                        return "multiple"
                    } else {
                       categoryOut = "sporting"
                    }
                } else if (this.events[i].category =="community") {
                    counter ++;
                    if (counter > 1) { 
                        return "multiple"
                    } else {
                ...
                } else if (this.events[i].category =="business") {
                    counter ++;
                    if (counter > 1) { 
                        return "multiple"
                    } else {
                ...
                } else if (this.events[i].category =="art") {
                    counter ++;
                    if (counter > 1) { 
                        return "multiple"
                    } else {
